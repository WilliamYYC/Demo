...
{
    //private static GameObject _lastLoadPrefab;
    //private static string _lastPrefabPath;
    ...
    static public bool useAssetBundle = false;
    ...
    static public void Init()
    {
      ...
      //  AssetBundle obj = Load("AssetBundles");
     //   _manifest = obj.LoadAsset("assetbundlemanifest") as AssetBundleManifest;
...
//     static public AudioClip LoadAudioClip(string path, string name)
//     {
// #if UNITY_EDITOR
//         if (useAssetBundle == false)
//         {
...
//         return LoadAssetBundle(path.ToLower()).LoadAsset<AudioClip>(name);
//     }
